...
bromo-model predict \
    --model ../../ModelCheckpoints/Pretrained/bromo/human-astral/peptide_transformer_full*.pth \
...
for seed_value in "${seed_values[@]}"; do
    # 0.01
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.01/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    # # #0.025
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.025/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    # # #0.05
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.05/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    # #0.1
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/seed0/sample_0.1/peptide_transformer_full_step1100_best.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    #0.5
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.5/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    #0.6
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.6/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    #0.75
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.75/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    #0.9
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.9/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
    ...
    #0.95
    bromo-model predict \
        --model ../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.95/peptide_transformer_full*.pth \
        --test-file ../../Datasets/pretraining/human-astral/val.tsv \
        --max-len 30 \
        --max-charge 4 \
