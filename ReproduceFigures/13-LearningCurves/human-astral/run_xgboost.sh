...
for seed_value in "${seed_values[@]}"; do
    ...
    bromo-xgboost train \
        --train_file ../../../Datasets/learning_curve/human-astral/${seed_value}/sample_0.025/sampled_proteins_0.025.tsv \
        --val_file ../../../Datasets/learning_curve/human-astral/${seed_value}/sample_0.025/val.tsv \
        --output_dir ../../../ModelCheckpoints/LearningCurves/human-astral/${seed_value}/sample_0.025 \
        --mode single \
        --add_terminal \
        --load_config ../../../ModelCheckpoints/Pretrained/xgboost/human-astral/xgboost_config.json
